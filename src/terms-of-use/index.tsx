  ...
  return (
    <div className={styles.background}>
      <div className={styles.centreBox}>
        <h1 className="header1">Usage Terms and Conditions</h1>
        <p>
          Welcome to Pocket Book. If you continue to browse and use this
        ...
        <p>
          The terms "I", "me", "us", "we" and "our" all refer to the owner of
          this website, who is Tony Richards. The term "you" refers to the user
        ...
        <ul>
          ...
          <li>
            This website uses cookies in accordance with our privacy policy.
          </li>
          <li>
            Neither we, nor any third party provide any warranty or guarantee
            as to the accuracy, timeliness, performance, completeness or
            suitablility of the information and materials found or offered on
          ...
          <li>
            ...
            own responsibility to ensure that any products, services of
            information available through this website meet your specific
            requirements.
          </li>
          <li>
            This website contains material which is owned or licensed to us.
        ...
        <p>
          This is not an official St John Ambulance website. The information
          enclosed is provided in good faith to volunteers from St John
          Ambulance, to assist them in their work. While every effort is made to
          ensure that the guidelines in this website are in line with current St
          John Ambulance policy, it is the responsibility of the user to ensure
          that they are following correct and current St John Ambulance policy
          and procedure.
        </p>
      </div>
    </div>
